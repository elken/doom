...
(after! engrave-faces
  (add-to-list 'engrave-faces-themes
             '(doom-nord
               (default :short "default" :slug "D" :family "Iosevka" :foreground "#ECEFF4" :background "#2E3440")
               ...
               (outline-1 :short "o-1" :slug nil :foreground "#81A1C1" :weight bold)
               (outline-2 :short "o-2" :slug nil :foreground "#B48EAD" :weight bold)
               (outline-3 :short "o-3" :slug nil :foreground "#5D80AE" :weight bold)
               (outline-4 :short "o-4" :slug nil :foreground "#a0b8d0" :weight bold)
               (outline-5 :short "o-5" :slug nil :foreground "#c6aac1" :weight bold)
               (outline-6 :short "o-6" :slug nil :foreground "#c0d0e0" :weight bold)
               (outline-7 :short "o-7" :slug nil :foreground "#d9c6d6" :weight bold)
               (outline-8 :short "o-8" :slug nil :foreground "#e5ecf2" :weight bold)
...
(require 'ox-publish)
(add-hook 'htmlize-before-hook #'rainbow-delimiters-mode)
