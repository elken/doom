...
(custom-theme-set-faces! 'doom-nord
  ...
  `(corfu-default :font "Iosevka Nerd Font Mono" :background ,(face-attribute 'default :background) :foreground ,(face-attribute 'default :foreground))
  `(markup-title-0-face :foreground ,(doom-color 'blue) :height 1.2)
  `(markup-title-1-face :foreground ,(doom-color 'magenta) :height 1.1)
  `(markup-title-2-face :foreground ,(doom-color 'violet) :height 1.05)
  `(markup-title-3-face :foreground ,(doom-lighten (doom-color 'blue) 0.25) :height 1.0)
  `(markup-title-4-face :foreground ,(doom-lighten (doom-color 'magenta) 0.25) :height 1.1)
  `(markup-verbatim-face :background nil)
  `(markup-list-face :background nil)
  `(markup-internal-reference-face :foreground ,(face-attribute 'font-lock-comment-face :foreground)))
#+end_src
...
(package! bhr
  :recipe
  (:local-repo "~/build/elisp/bamboo.el/"
   :build (:not compile)))
#+end_src
