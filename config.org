...
(use-package! laravel-mode
  :hook (+php-laravel-mode . laravel-mode)
  :init
  (set-popup-rule! "^\\tinker:" :vslot -5 :size 0.35 :select t :modeline nil :quit nil :ttl nil)
  (map! :leader
         :desc "Tinker REPL" "o r" #'laravel-mode-toggle-tinker))
#+end_src
