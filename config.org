...
namespace `(substring (replace-regexp-in-string "/" (regexp-quote "\\") (s-titleize (file-name-directory (file-relative-name buffer-file-name (projectile-project-root))))) 0 -1)`;
