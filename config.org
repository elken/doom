...
#+begin_src emacs-lisp
(add-hook! 'org-babel-pre-tangle-hook (when (file-directory-p "snippets") (delete-directory "snippets" t (not (null delete-by-moving-to-trash)))))
#+end_src
...
(setq  doom-font (font-spec :family "Iosevka Nerd Font Mono" :size 13)
       ...
       doom-unicode-font (font-spec :family "Iosevka Nerd Font Mono" :size 16)
