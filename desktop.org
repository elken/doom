...
(after! (exwm doom-modeline)
  ...
  (doom-modeline-def-modeline 'main
    ...
    '(objed-state misc-info persp-name grip mu4e gnus github debug repl lsp minor-modes buffer-encoding major-mode process vcs checker)))
