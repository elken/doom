...
exec dbus-launch --exit-with-session emacs -mm --use-exwm -l ~/.doom.d/desktop.el
#+end_src
...
xset -dpms
xset s off
exec dbus-launch --exit-with-session emacs -mm --debug-init --use-exwm -l ~/.doom.d/desktop.el
#+end_src
